                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        <!-- Title -->
                         ...
                         <div class="row">
                            <div class="col-12">
                                <a href="?controller=<?php echo $controller; ?>&redirect=<?php echo $redirect; ?>&action=create" type="button" class="btn btn-outline-success my-4" tabindex="-1" role="button" aria-disabled="true">
                                ...
                                <table class="table my-3">
                                    ...
                                    ?>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <a href="?controller=<?php echo $controller ?>&redirect=<?php echo $redirect; ?>&action=edit&user_id=<?php echo $item['user_id'] ?> " type="button" class="btn btn-outline-primary my-1" tabindex="-1" role="button" aria-disabled="true">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <a href="?controller=<?php echo $controller ?>&redirect=<?php echo $redirect; ?>&action=destroy&user_id=<?php echo $item['user_id'] ?> " type="button" class="btn btn-outline-danger my-1" tabindex="-1" role="button" aria-disabled="true">
