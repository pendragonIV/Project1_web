                ...
                <div class="row">
                    <div class="col-3 shadow p-3 bg-body rounded mb-3 min-vh-100">
                        <div class="btn-group-vertical col-12 " role="group" aria-label="Basic example">
                            ...
                            <a href="?controller=user" class="btn border-0 rounded text-start" tabindex="-1" role="button" aria-disabled="true">Member management</a>
                            ...
                            <a href="" class="btn border-0 rounded text-start bg-primary text-light" tabindex="-1" role="button" aria-disabled="true">Product management</a>
                    ...
                    <div class="col-9">
                        ...
                        <!-- Title -->
                         ...
                         <div class="row">
                            <div class="col-12">
                                <a href="index.php?controller=product&action=create" type="button" class="btn btn-outline-success my-4" tabindex="-1" role="button" aria-disabled="true">
                            ...
                            <div class="col">
                                <table class="table my-3">
                                    ...
                                    ?>
                                            ...
                                            <td class="col-2">
                                                <a href="?controller=product&action=edit&product_id=<?php echo $item['product_id']; ?>" type="button" class="btn btn-outline-primary my-1" tabindex="-1" role="button" aria-disabled="true">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                                <a href="?controller=product&action=destroy&product_id=<?php echo $item['product_id']; ?>" type="button" class="btn btn-outline-danger my-1" tabindex="-1" role="button" aria-disabled="true">
